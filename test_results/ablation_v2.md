...
| Anchors proposed | 95 | 72 | `format` |
| Anchors surviving the check | 65/95 (68%) | 72/72 (100%) | `format` |
| Problems named | 9/55 (16%) | 8/55 (15%) | `content` |
| Confidently false descriptions | 8/20 | 7/20 | `content` |
| Text scored (chars) | 40,865 | 12,207 | `caveat` |

## What the training bought

- **Format compliance: +100%** valid JSON
- **Problems named: -1.8%** of concepts
- **Fewer false descriptions: +5%** of samples
